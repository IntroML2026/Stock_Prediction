...
MODEL_INFO = {
        ...
        "keys": ["WMT", "TGT", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["WMT", "TGT", "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"]]
}
